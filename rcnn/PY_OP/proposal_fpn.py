...
class ProposalFPNOperator(mx.operator.CustomOp):
    def __init__(self, feat_stride_fpn, scales, ratios, output_score,
        ...
        self._anchors_fpn = dict(
            zip(self.fpn_keys, generate_anchors_fpn(base_size=fpn_stride, scales=self._scales, ratios=self._ratios)))
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        if len(keep) < post_nms_topN:
            # TODO: Why sampling from the post NMS results
