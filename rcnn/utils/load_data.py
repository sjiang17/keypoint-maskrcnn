...
def load_gt_roidb(dataset_name, image_set_name, root_path, dataset_path, flip=False, load_memory=False):
    """ load ground truth roidb """
    imdb = eval(dataset_name)(image_set_name, root_path, dataset_path, load_memory)
    roidb = imdb.gt_roidb()
    if flip:
...
def load_proposal_roidb(dataset_name, image_set_name, root_path, dataset_path,
                        proposal='rpn', append_gt=True, flip=False, load_memory=False, use_mask=False, panoptic=False):
