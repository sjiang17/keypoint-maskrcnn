...
def check_model(prefix, epoch):
    ...
    print(len(aux_names))
    for aux in aux_names:
        if aux.startswith('bn1'):
            auxs1.pop(aux)
        print(aux)
    prefix_out = '/mnt/truenas/scratch/siyu/deep-vehicle-intention/inte/models/pretrained/vgg-16_resnet-18_3block'
...
if __name__ == "__main__":
    ...
    model_path = '/mnt/truenas/scratch/siyu/deep-vehicle-intention/inte/models/pretrained/resnet_slim_v12_2018_11_15_resnet-18_2block_cut'
